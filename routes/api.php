...
|               activity.logger | rate.limit:{type} | cache.response
|
*/
...
// =========================================================================
Route::middleware(['auth:sanctum', 'church.admin', 'activity.logger', 'rate.limit:api'])
     ->group(function () {
    ...
    // -------------------------------------------------------------------
    // Transactions — core financial recording (all admins, scoped)
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // Churches — all admins view; create/delete restricted
    // -------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------
    // Zones — zone admin views; ministry admin full CRUD
    // -------------------------------------------------------------------
    Route::middleware('zone.admin')->group(function () {
    ...
    // -------------------------------------------------------------------
    // Activity Logs — all admins (scoped by role)
    // -------------------------------------------------------------------
